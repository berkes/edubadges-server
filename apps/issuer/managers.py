...
class BadgeClassManager(BaseOpenBadgeObjectManager):
    ...
    def create(self, **kwargs):
        new_kwargs = {
            ...
            if key != "award_allowed_institutions"
        }
    ...
    def get_or_create_from_ob2(
        self, issuer, badgeclass_obo, source=None, original_json=None
    ):
...
class BadgeInstanceManager(BaseOpenBadgeObjectManager):
    ...
    def create(self, evidence=None, extensions=None, allow_uppercase=False, **kwargs):
        ...
        recipient_identifier = (
            recipient_identifier if allow_uppercase else recipient_identifier.lower()
        )
