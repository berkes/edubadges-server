...
class StaffListViewBase(VersionedObjectMixin, BaseEntityListView):
    ...
    def post(self, request, **kwargs):
        ...
        object = self.get_object(
            request, **kwargs
        )  # trigger a has_object_permissions() check on the model instance
...
class StaffDetailViewBase(BaseEntityDetailView):
    ...
    def put(self, request, **kwargs):
        object = self.get_object(
            request, **kwargs
        )  # triggers a has_object_permissions() check on the model instance
    ...
    def delete(self, request, **kwargs):
        ...
        logger.event(
            badgrlog.PermissionDeletedEvent(staff_instance=obj, request=request)
        )
        obj.delete()
