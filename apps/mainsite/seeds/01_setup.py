...
surf_net_institution, _ = Institution.objects.get_or_create(
    name_english=SURF_INSTITUTION_NAME,
...
terms_service_agreement_student, _ = Terms.objects.get_or_create(
    institution=None, terms_type=Terms.TYPE_SERVICE_AGREEMENT_STUDENT
)
TermsUrl.objects.get_or_create(
    terms=terms_service_agreement_student,
    language=TermsUrl.LANGUAGE_ENGLISH,
    url="https://raw.githubusercontent.com/edubadges/privacy/master/service-agreement-student-en.md",
)
TermsUrl.objects.get_or_create(
    terms=terms_service_agreement_student,
    language=TermsUrl.LANGUAGE_DUTCH,
    url="https://raw.githubusercontent.com/edubadges/privacy/master/service-agreement-student-nl.md",
)
terms_service_agreement_employee, _ = Terms.objects.get_or_create(
    institution=None, terms_type=Terms.TYPE_SERVICE_AGREEMENT_EMPLOYEE
)
TermsUrl.objects.get_or_create(
    terms=terms_service_agreement_employee,
    language=TermsUrl.LANGUAGE_ENGLISH,
    url="https://raw.githubusercontent.com/edubadges/privacy/master/service-agreement-employee-en.md",
)
TermsUrl.objects.get_or_create(
    terms=terms_service_agreement_employee,
    language=TermsUrl.LANGUAGE_DUTCH,
    url="https://raw.githubusercontent.com/edubadges/privacy/master/service-agreement-employee-nl.md",
)
terms_of_service, _ = Terms.objects.get_or_create(
    institution=None, terms_type=Terms.TYPE_TERMS_OF_SERVICE
)
TermsUrl.objects.get_or_create(
    terms=terms_of_service,
    language=TermsUrl.LANGUAGE_ENGLISH,
    url="https://raw.githubusercontent.com/edubadges/privacy/master/edubadges-termsofservice-en.md",
)
TermsUrl.objects.get_or_create(
    terms=terms_of_service,
    language=TermsUrl.LANGUAGE_DUTCH,
    url="https://raw.githubusercontent.com/edubadges/privacy/master/edubadges-termsofservice-nl.md",
)


add_terms_institution(surf_net_institution)
# surf_net_institution.remove_cached_data(['cached_terms'])
edu_badges_faculty, _ = Faculty.objects.get_or_create(
    name_english=EDU_BADGES_FACULTY_NAME,
    institution=surf_net_institution,
    description_english=EDU_BADGES_FACULTY_NAME,
    description_dutch=EDU_BADGES_FACULTY_NAME,
)
surf_issuer, _ = Issuer.objects.get_or_create(
    name_english=EDU_BADGES_ISSUER_NAME,
