...
json_patterns = [
    ...
    url(
        ...
        xframe_options_exempt(
            BadgeClassPublicKeyJson.as_view(slugToEntityIdRedirect=True)
        ),
...
image_patterns = [
    url(
        r"^institution/(?P<entity_id>[^/]+)/image$",
